...
; convert
(define-fun |B4| () Bool (and (not (bvuge |main::1::S1!0@1#1| (_ bv10 32))) (not (bvuge |main::1::S2!0@1#1| (_ bv10 32))) (not (bvuge |main::1::S3!0@1#1| (_ bv10 32)))))

; set_to false
(assert (not (bvuge |main::1::S1!0@1#1| (_ bv10 32))))

; set_to false
(assert (not (bvuge |main::1::S2!0@1#1| (_ bv10 32))))

; set_to false
(assert (not (bvuge |main::1::S3!0@1#1| (_ bv10 32))))
